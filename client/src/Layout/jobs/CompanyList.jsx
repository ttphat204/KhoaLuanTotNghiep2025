        ...
        <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="md:col-span-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 bg-gray-50 dark:bg-gray-700 focus:bg-white dark:focus:bg-gray-600 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                  />
                </div>
              </div>
              ...
              <div>
                <select
                  ...
                  className="w-full px-4 py-4 border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 bg-gray-50 dark:bg-gray-700 focus:bg-white dark:focus:bg-gray-600 text-gray-900 dark:text-white"
                >
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm">
              ...
              <div className="text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-700 px-3 py-1 rounded-lg text-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredCompanies.map((company) => (
              <div key={company._id} className="group bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div className="relative p-6 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border-b border-gray-100 dark:border-gray-700">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-lg font-bold text-gray-900 dark:text-white truncate group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">{company.companyName}</h3>
                ...
                <div className="p-6">
                  <div className="space-y-4">
                    <div className="flex items-center text-sm bg-gray-50 dark:bg-gray-700 px-3 py-2 rounded-lg">
                    ...
                    {company.companySize !== 'Chưa cập nhật' && (
                      <div className="flex items-center text-sm bg-gray-50 dark:bg-gray-700 px-3 py-2 rounded-lg">
                        ...
                        <span className="text-gray-700 dark:text-gray-200 font-medium">{company.companySize}</span>
                      </div>
                    )}
                    
                    <div className="flex items-center text-sm bg-gray-50 dark:bg-gray-700 px-3 py-2 rounded-lg">
                      <FaBriefcase className="mr-3 text-purple-500 flex-shrink-0" />
                      <span className="text-gray-700 dark:text-gray-200 font-medium">{company.jobCount} việc làm đang tuyển</span>
                    </div>
                  </div>
          ...
          {filteredCompanies.length === 0 && (
            <div className="text-center py-16">
              <div className="max-w-md mx-auto">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Không tìm thấy công ty</h3>
